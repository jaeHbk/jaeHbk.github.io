// This is the original JavaScript for the generative art header.
var nmobiles = 400;
var mobiles = [];
...
function setup() {
    ...
    const height = sketchHolder.offsetHeight > 0 ? sketchHolder.offsetHeight : width; // Ensure height is not 0
    ...
    // Adjust canvas style after creation
    setTimeout(() => {
